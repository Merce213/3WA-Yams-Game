				...
				<div className="container p-3 flex flex-col pt-16 items-center gap-12 justify-center h-2/3">
					...
					<div className="w-full max-w-lg">
						<p className="text-white font-yams-body">
							Embark on a delectable journey as you step into the
							world of a pastry shop. Your mission? Craft a
							winning strategy in a game of Yams infused with
							sweet rewards. Roll the dice, strategize your moves,
							and aim for three tantalizing treats!
						</p>
					</div>
					...
					<div className="flex flex-col gap-2">
						...
						<p className="text-white text-center font-yams-body md:absolute md:bottom-0 md:right-0 md:p-4 hover:scale-105 hover:underline hover:underline-offset-2 transition-all duration-200">
							Credits
						</p>
					</div>
				</div>
